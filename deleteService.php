    ...
    <body>
        ...
        <div class = "content" style="margin-bottom: 300px; margin-top: 100px;">
            <div class = "container" style="margin-bottom:200px; margin-top: 50px;">
                ...
                <form action="deleteService.php" method="Post" class="form-horizontal">
                    ...
                    <br><br><br><br><br>
                    <input type="submit" class ="btn btn-lg btn-danger pull-left" name="submit" value="Delete Service" />
