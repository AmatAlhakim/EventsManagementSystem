...
class Upload {
    ...
    function __construct() {
        $this->upload_dir = '';
        $this->max_file_size = 20971520 ; //Max File Size in Bytes, 20MB
    ...
    public function upload($object) {
        $sesion = '';
        if (isset($_SESSION['locationName']) && !empty($_SESSION['locationName'])) {
            $sesion = $_SESSION['locationName'] . '/';
