    ...
    <body>
        ...
        if (isset($_POST['submitted'])) {
            if (isset($_POST['sure']) && ($_POST['sure'] == 'Yes')) { //delete the record   
                ...
                echo '<h3> User ' . $client->getName() . '  deletion was not confirmed</h3>';
            }
        ...
        <div class = "content">
            <div class = "container" style="margin-bottom:200px; margin-top: 50px;">
                <h1>Confirm Client <b style="color:red">" <?php echo $client->getName(); ?> " </b> Deletion Process </h1><!--form title-->
                <form action="deleteClient.php" method="Post" class="form-horizontal">
                    <h3>Delete This Client <b style="color:red">" <?php echo $client->getName(); ?> " </b>Record Permanently????</h3>
                    <br><br><br><br><br>
                    ...
                    <br><br><br>
                    <a class="btn btn-lg btn-info" href="manageClients.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Cancel</a><!--return/back button-->
                </form>
            </div>
        </div>
