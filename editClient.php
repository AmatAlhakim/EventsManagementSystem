    ...
    <body>
        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editClient.php" method="Post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="RoyaltyPoint" class="col-md-2 control-label">Royalty Point</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" 
                                   class="form-control" 
                                   id="RoyaltyPoint" 
                                   name="RoyaltyPoint" 
                                   value="<?php echo $client->getRoyaltyPoint(); ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                            <span id="RoyaltyPointError" class="error"></span><!--error message for invalid input-->
                        </div>
                    </div>
                    <br><br>

                    <button type="submit" class="btn btn-lg btn-primary pull-right" name="submit">Update <span class="glyphicon glyphicon-floppy-disk"></span></button>
                    <input type ="hidden" name="submitted" value="1">
                    <input type ="hidden" name="id" value="<?php echo $id ?>"/>
                    <a class="btn btn-lg btn-info" href="manageClients.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a><!--return/back button-->
                </form>
            </div>
        </div>
